...
# under the License.
"""Debug agent — diagnoses and repairs failed SQL queries."""
...
from superset.ai.prompts.debug import DEBUG_SYSTEM_PROMPT
...
class DebugAgent(BaseAgent):
    """Agent that diagnoses SQL errors and generates corrected queries.

    Tools: get_schema + execute_sql (same as NL2SQL, but with a debug-oriented
    system prompt that focuses on error analysis and repair).
    """
